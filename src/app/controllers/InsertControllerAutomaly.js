...
class InsertControllerAutomaly {
    ...
    // [POST] /InsertCategory
    insertCategoryAutomaly(req, res) {
        Category.insertMany([
    ...
    deleteCategoryAutomaly(req, res) {
...
module.exports = new InsertControllerAutomaly;